...
def init_model():
    ...
    parser.add_argument("--known_cls_ratio", default=1, type=float, required=True,
                        help="The ratio of known classes.")

    parser.add_argument('--seed', type=int, default=0,
                        help="Random seed.")

    parser.add_argument("--method", type=str, default='HNSCL',
    ...
    parser.add_argument("--num_pretrain_epochs", default=3, type=float,
